...
interface JumboListNoDataPlaceholderProps {
  children?: React.ReactNode;
  sx?: SxProps<Theme>;
}

const JumboListNoDataPlaceholder: React.FC<JumboListNoDataPlaceholderProps> = ({ 
  children,
  sx 
}) => {
  return (
...
export default React.memo(JumboListNoDataPlaceholder);