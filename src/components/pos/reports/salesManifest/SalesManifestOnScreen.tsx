    ...
    return !belowLargeScreen ? (
      ...
      <Tooltip title={label}>
        <Stack direction={'row'} spacing={0.5} display={'flex'}>
          {label && (
            <Typography fontWeight={'bold'} variant='caption' flex={{ xs: 2, md: 1 }} color={color}>
              {label}:
            </Typography>
          )}
          <Typography flex={{ xs: 3, md: 2 }} color={color}>
            {value}
          </Typography>
        </Stack>
      </Tooltip>
        ...
        {reportData.transactions.map((sale, index) => {
          ...
          return (
            ...
            >
              ...
              <AccordionDetails sx={{ marginBottom: 3 }}>
                {!belowLargeScreen ? (
                  <Grid container>
                    <Grid size={12}>
                        ...
                        <Table stickyHeader size='small'>
                            ...
                            <TableRow
                              sx={{
                                '& th': {
                                  ...
                                  top: 0,
                                  zIndex: 2,
                                  backgroundColor: totalProfit < 0 ? 'rgba(251, 244, 242, 0.2)' : undefined,
                            ...
                            {sale.items.map((item, itemIndex) => (
                              ...
                              >
                                ...
                                <SalesItemInfo 
                                  label={'Quantity'} 
                                  textAlign={'right'} 
                                  value={`${item.quantity} ${item.measurement_unit.symbol}`}
                                />
                                <SalesItemInfo 
                                  label={'Price'} 
                                  textAlign={'right'} 
                                  value={
                                    separateVAT 
                                      ...
                                      : (item.rate + (item.product.vat_exempted 
                                          ? 0 
                                          : item.rate * vat_percentage * 0.01
                                  ...
                                  value={
                                    separateVAT 
                                      ...
                                      : ((item.quantity * item.rate) + 
                                        (item.product.vat_exempted 
                                          ? 0 
                                          : (item.quantity * item.rate) * vat_percentage * 0.01
                                        )).toLocaleString('en-US', {
                                          maximumFractionDigits: 2,
                                          minimumFractionDigits: 2
                                        })
                                ...
                                {financePersonnel && (
                                  <>
                                    ...
                                    <SalesItemInfo 
                                      ...
                                      textAlign={'right'} 
                                      value={
                                        ((item.quantity * item.rate) - (item.cost))
                                          .toLocaleString('en-US', {
                                            maximumFractionDigits: 2,
                                            minimumFractionDigits: 2
                                          })
                          ...
                          <TableBody>
                            ...
                            >
                                ...
                                <SalesItemInfo value="" />
                                <SalesItemInfo value="" />
                                <SalesItemInfo value={<strong>Total</strong>} />

                                <SalesItemInfo 
                                    label="Total Amount" 
                                    textAlign="right" 
                                    color="blue" 
                                    value={sale.items.reduce((total, currentItem) => 
                                    total + (separateVAT 
                        ...
                        >
                          ...
                          <Grid size={{xs: 11, md: 7.5, lg: 5.5}}>
                            <Tooltip title="Product">
                              <Typography>{saleItem.product.name}</Typography>
                            </Tooltip>
                          </Grid>
                          <Grid size={{xs: 6, md: 4, lg: 3}}>
                            <SalesItemInfo 
                              label={'Qty'} 
                              value={`${saleItem.quantity} ${saleItem.measurement_unit.symbol}`}
                            />
                          </Grid>
                          <Grid size={{xs: 6, md: 4, lg: 3}}>
                            <SalesItemInfo 
