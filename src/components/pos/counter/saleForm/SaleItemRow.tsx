         ...
         <React.Fragment>
            ...
            { !showForm ? (
                    ...
                    >
                        ...
                        <Grid item xs={1} lg={vat_factor ? 0.5 : 1}>
                            <Tooltip title="Unit">
                        ...
                        <Grid textAlign={'end'} item xs={2} md={1} lg={vat_factor ? 0.5 : 1}>
                            <Tooltip title="Quantity">
                                <Typography>{item.quantity}</Typography>
                            </Tooltip>
                        </Grid>
                        <Grid textAlign={'end'} item xs={4} md={2} lg={vat_factor ? 1.5 : 2}>
                            <Tooltip title="Price">
                        ...
                        <Grid textAlign={'end'} item xs={12} lg={1}>
