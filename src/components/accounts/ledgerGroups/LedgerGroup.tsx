...
export default function LedgerGroup() {
    ...
    if(!(checkOrganizationPermission(PERMISSIONS.ACCOUNTS_MASTERS_READ) || checkOrganizationPermission(PERMISSIONS.ACCOUNTS_MASTERS_CREATE))){
        return <UnauthorizedAccess/>;
    }
    return (
        <LedgerGroupProvider>
            <Typography variant={'h4'} mb={2}>Ledger Groups</Typography>
