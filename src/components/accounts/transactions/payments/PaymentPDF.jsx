...
function PaymentPDF({transaction, authObject}) {
        ...
        <Page size="A4" style={pdfStyles.page}>
            ...
            <View style={{...pdfStyles.table, minHeight: 230, marginTop: 10}}>
                <View style={pdfStyles.tableRow}>
                    ...
                    <Text style={{...pdfStyles.tableHeader, backgroundColor: mainColor, color: contrastText, flex : 2 }}>Account Paid (Debit)</Text>
