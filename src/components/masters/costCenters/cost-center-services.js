...
costCenterservices.getCostCenters = async(response) => {
    const {data} = await axios.get(`/api/cost-centers/all-cost-centers`)
    return data;
}

costCenterservices.costCenterDetails = async(id) => {
    const {data} = await axios.get(`/api/cost-centers/${id}/costCenterDetails`);
    return data;
}

costCenterservices.getAllOutlets = async(response) => {
    const {data} = await axios.get(`api/cost-centers/getAllOutlets`)
    return data;
}

costCenterservices.add = async(costCenter) => {
    return await axios.get('/sanctum/csrf-cookie').then(async (response) => {
        const {data} = await axios.post(`/api/cost-centers/add`,costCenter)
        return data;
    })
}
...
costCenterservices.update = async(costCenter) => {
    return await axios.get('/sanctum/csrf-cookie').then(async (response) => {
        const {data} = await axios.put(`/api/cost-centers/${costCenter.id}/update`,costCenter)
        return data;    
    })
}
